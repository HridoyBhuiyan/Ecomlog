...
<head>
    ...
    @yield('seometa')
    @vite([
    'resources/css/responsive.css', 'resources/css/override.css', 'resources/css/style.css', 'resources/css/fontawesome.min.css', 'resources/css/bootstrap.min.css', 'resources/js/script.js',
    ])
</head>
<body>
